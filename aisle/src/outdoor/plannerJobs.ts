...
export const JOB_DEADLINES_MS: Readonly<Record<PlannerJob, { firstToken: number; total: number }>> = {
  routeCompile: { firstToken: 1500, total: 8000 },
  crossingAnnounce: { firstToken: 1500, total: 8000 },
  parseIntent: { firstToken: 1500, total: 4000 },
  disambiguate: { firstToken: 1500, total: 4000 },
  answer: { firstToken: 1500, total: 4000 },
};
